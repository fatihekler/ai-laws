...
add('US-COMP-006','US','OFFICIAL_GUIDANCE','DOJ/FTC Antitrust Policy Statement on Sharing of Cybersecurity Information','https://www.ftc.gov/system/files/documents/public_statements/297681/140410ftcdojcyberthreatstmt.pdf',['Antitrust Policy Statement on Sharing of Cybersecurity Information','cyber threat information'],'PDF','Current DOJ guidance list still includes this 2014 statement; cybersecurity analogy only, not an AI-safety safe harbor.')
add('US-COMP-007','US','OFFICIAL_STAFF_REPORT','FTC Staff Report on AI Partnerships & Investments 6(b) Study','https://www.ftc.gov/system/files/ftc_gov/pdf/p246201_aipartnerships6breport_redacted_0.pdf',['Partnerships Between Cloud Service Providers and AI Developers','Areas to Watch'],'PDF','Staff study based on three partnerships; identifies areas to watch, not adjudicated violations.')
add('US-COMP-008','US','OFFICIAL_POLICY_STATUS','FTC/DOJ Withdrawal of Collaboration Guidelines','https://www.justice.gov/atr/media/1380001/dl?inline=',['withdraw','Antitrust Guidelines for Collaborations Among Competitors'],'ANY','Records December 2024 withdrawal; withdrawn guidelines must not be treated as current safe harbor.')
